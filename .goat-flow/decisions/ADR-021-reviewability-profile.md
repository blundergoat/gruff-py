...
| `complexity.npath` | **advisory**, MEDIUM conf | demote from error | Weakest proxy; multiplicative FP on the recommended guard style; threshold-raising futile; Goodhart-gameable. |
