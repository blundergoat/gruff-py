...
`.goat-flow/decisions/ADR-019-per-command-minimum-severity.md` (search:
...
ADR-019 records the contract; cross-port coordination posture is recorded
in `.goat-flow/tasks/0.1.2/ISSUE.md` (search: `Coordination posture`).
