...
run_self_test() {
  ...
  run_case "gh issue comment body-file blocked" "gh issue comment 64620 --repo acme/repo --body-file /tmp/issue_64620_comment.md" 2 smoke
  ...
  run_case "gh issue view allowed" "gh issue view 64620 --repo acme/repo --comments" 0 smoke
  ...
  run_case "gh global repo issue comment blocked" "gh --repo acme/repo issue comment 64620 --body-file /tmp/issue_64620_comment.md" 2
  run_case "gh topic repo issue comment blocked" "gh issue --repo acme/repo comment 64620 --body-file /tmp/issue_64620_comment.md" 2 smoke
  run_case "gh topic short repo pr review blocked" "gh pr -R acme/repo review 123 --approve" 2
  ...
  run_case "gh topic repo issue view allowed" "gh issue --repo acme/repo view 64620 --comments" 0
