...
by task; the table below names where its content now lives.
...
See [Output Formats → JSON](output-formats.md#json).

## Exit Codes

See [Output Formats → Exit Codes](output-formats.md#exit-codes).
