...
class RuleRegistry:
    ...
    def defaults(cls) -> "RuleRegistry":
        ...
        from gruffpy.rule.dead_code.unused_private_attribute_rule import (
            UnusedPrivateAttributeRule,
        )
        from gruffpy.rule.dead_code.unused_private_function_rule import (
            UnusedPrivateFunctionRule,
        )
        from gruffpy.rule.design.single_implementor_protocol_rule import (
        ...
        from gruffpy.rule.sensitive_data.database_url_password_rule import (
        ...
        from gruffpy.rule.test_quality.magic_number_assertion_rule import (
            MagicNumberAssertionRule,
        )
        from gruffpy.rule.test_quality.mock_only_test_rule import MockOnlyTestRule
        from gruffpy.rule.test_quality.mock_without_expectation_rule import (
        ...
        from gruffpy.rule.test_quality.parametrize_annotation_rule import (
        ...
        from gruffpy.rule.test_quality.skipped_without_reason_rule import (
        ...
        from gruffpy.rule.test_quality.test_function_too_long_rule import (
