...
class DashboardPageRenderer:
    def dashboard_html(self, state: dict[str, str]) -> str:
        ...
        return (
            ...
            f"<title>gruff dashboard</title><style>{_DASHBOARD_CSS}</style></head><body>"
            ...
            f'<iframe id="report-frame" title="gruff report" data-initial-src="{_esc_attr(scan_url)}" '
    ...
    def error_html(
        ...
        *,
        ...
        return (
            '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">'
            '<meta name="viewport" content="width=device-width, initial-scale=1.0">'
            "<title>gruff dashboard error</title>"
